...
const Signup: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070b15] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-80 h-80 rounded-full bg-[#3b82f6]/10 blur-[100px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-lg glass-card rounded-2xl p-8 z-10 animate-fade-in my-8">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Get started with our MERN project workflow</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          {/* Conditional Profile Fields for PM / Employee */}
          {selectedRole !== "admin" && (
